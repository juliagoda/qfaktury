...
void Ustawienia::init() {
    ...
    connect( kontrinfoname, SIGNAL( stateChanged(int) ), this, SLOT( zastBtnEnable() ) );
    connect( kontrinfocity, SIGNAL( stateChanged(int) ), this, SLOT( zastBtnEnable() ) );
    connect( kontrinfoaddress, SIGNAL( stateChanged(int) ), this, SLOT( zastBtnEnable() ) );
    connect( kontrinfoaccount, SIGNAL( stateChanged(int) ), this, SLOT( zastBtnEnable() ) );
    connect( kontrinfotic, SIGNAL( stateChanged(int) ), this, SLOT( zastBtnEnable() ) );
    connect( kontrinfotel, SIGNAL( stateChanged(int) ), this, SLOT( zastBtnEnable() ) );
    connect( kontrinfomail, SIGNAL( stateChanged(int) ), this, SLOT( zastBtnEnable() ) );
    connect( kontrinfowww, SIGNAL( stateChanged(int) ), this, SLOT( zastBtnEnable() ) );
...
void Ustawienia::saveSettings() {
    ...
    sett().setValue("kontrnazwa", kontrinfoname->isChecked());
    sett().setValue("kontrmiejscowosc", kontrinfocity->isChecked());
    sett().setValue("kontradres", kontrinfoaddress->isChecked());
    sett().setValue("kontrkonto", kontrinfoaccount->isChecked());
    sett().setValue("kontrnip", kontrinfotic->isChecked());
    sett().setValue("kontrphone", kontrinfotel->isChecked());
    sett().setValue("kontrmail", kontrinfomail->isChecked());
    sett().setValue("kontrwww", kontrinfowww->isChecked());
    sett().endGroup();
...
void Ustawienia::readSettings() {
    ...
    sett().beginGroup("printkontr");
    kontrinfoname->setChecked(sett().value("kontrnazwa").toBool());
    kontrinfocity->setChecked(sett().value("kontrmiejscowosc").toBool());
    kontrinfoaddress->setChecked(sett().value("kontradres").toBool());
    kontrinfoaccount->setChecked(sett().value("kontrkonto").toBool());
    kontrinfotic->setChecked(sett().value("kontrnip").toBool());
    kontrinfotel->setChecked(sett().value("kontrphone").toBool());
    kontrinfomail->setChecked(sett().value("kontrmail").toBool());
