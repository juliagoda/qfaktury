...
{
	additEdit->setText(
		trUtf8("Oświadczam, że jestem rolnikiem ryczałtowym zwolnionym od podatku od towarów"
...
void InvoiceRR::makeInvoice()
{
	...
	if (!ifpaysVAT->isChecked())
	{
		QMessageBox::information(
			this,
			"QFaktury",
			trUtf8("Zaznacz opcję \"jest płatnikiem VAT\" dla wybranego przedsiębiorcy"),
			QMessageBox::Ok);
		return;
	}
