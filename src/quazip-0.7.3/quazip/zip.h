/* zip.h -- IO on .zip files using zlib
  ...
  to support QIODevice interface. Some improvements and small fixes were also
  made.
...
extern zipFile ZEXPORT zipOpen2 OF((voidpf file, int append,
                                    zipcharpc *globalcomment,
                                    zlib_filefunc_def *pzlib_filefunc_def));

extern zipFile ZEXPORT zipOpen2_64
OF((voidpf file, int append, zipcharpc *globalcomment,
...
/*
  ...
  extra field data
              zipRemoveExtraInfoBlock(pCenDirExtraFieldData,
  &nCenDirExtraFieldDataLen, 0x0001);

                        Remove ZIP64 Extra information from a Local File Header
  extra field data
        zipRemoveExtraInfoBlock(pLocalHeaderExtraFieldData,
