...
voidpf call_zopen64(const zlib_filefunc64_32_def *pfilefunc, voidpf file,
                    int mode) {
...
struct QIODevice_descriptor {
  ...
  qint64 pos;
  inline QIODevice_descriptor() : pos(0) {}
};
/// @endcond

voidpf ZCALLBACK qiodevice_open_file_func(voidpf opaque, voidpf file,
                                          int mode) {
...
uLong ZCALLBACK qiodevice_read_file_func(voidpf opaque, voidpf stream,
                                         void *buf, uLong size) {
  QIODevice_descriptor *d = reinterpret_cast<QIODevice_descriptor *>(opaque);
...
uLong ZCALLBACK qiodevice_write_file_func(voidpf opaque, voidpf stream,
...
int ZCALLBACK qiodevice_seek_file_func(voidpf /*opaque UNUSED*/, voidpf stream,
...
int ZCALLBACK qiodevice64_seek_file_func(voidpf /*opaque UNUSED*/,
...
int ZCALLBACK qiodevice_error_file_func(voidpf /*opaque UNUSED*/,
