...
- regularne tworzenie kopii zapasowej na życzenie
- eksportowanie danych do plików csv w celu wykorzystania w arkuszach kalkulacyjnych czy bazach danych
...
Program jest co jakiś czas uaktualniany. Plany jego rozbudowy, wykonane zadania i zadania w trakcie testów znajdują się na https://github.com/juliagoda/qfaktury/projects/1
...
W razie zauważonych błędów lub poważnych braków, można stworzyć wątek w https://github.com/juliagoda/qfaktury/issues , klikając w zielony przycisk "New issue" po prawej stronie, a następnie wprowadzając tytuł i treść. 
